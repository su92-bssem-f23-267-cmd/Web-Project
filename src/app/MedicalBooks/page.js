  ...
  <div className='flex w-full max-w-md bg-white rounded-full shadow-lg overflow-hidden'>
    ...
    <button className='px-5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold hover:from-indigo-600 hover:to-purple-700 transition-all duration-300'>
      ...
      <div className='flex flex-wrap justify-center gap-6 px-4'>
         ...
         <Medicalsection Bookname='Salaar Sikandar' Bookpicture='/SalaarSkindar.jpeg' Author_Name='Rizwan' Price='RS:1800' /> </Link>
        <Medicalsection Bookname='Salaar Imaama' Bookpicture='/SalaarImama.jpeg' Author_Name='Rizwan' Price='RS:1500' />
        <Medicalsection Bookname='Aab E Hayaat' Bookpicture='/Aab_E_Hayat.jpeg' Author_Name='Rizwan' Price='RS:1900' />
        <Medicalsection Bookname='Peer E Kamil' Bookpicture='/Peer_E_Kamil.jpeg' Author_Name='Rizwan' Price='RS:1400' />
      </div>
      <div className='flex flex-wrap justify-center gap-6 px-4'>
        <Medicalsection Bookname='Salaar Sikandar' Bookpicture='/SalaarSkindar.jpeg' Author_Name='Rizwan' Price='RS:1800' />
        <Medicalsection Bookname='Salaar Imaama' Bookpicture='/SalaarImama.jpeg' Author_Name='Rizwan' Price='RS:1500' />
        <Medicalsection Bookname='Aab E Hayaat' Bookpicture='/Aab_E_Hayat.jpeg' Author_Name='Rizwan' Price='RS:1900' />
        <Medicalsection Bookname='Peer E Kamil' Bookpicture='/Peer_E_Kamil.jpeg' Author_Name='Rizwan' Price='RS:1400' />
      </div>
