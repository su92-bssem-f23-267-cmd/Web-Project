  ...
  <div className='flex w-full max-w-md bg-white rounded-full shadow-lg overflow-hidden'>
    ...
    <button className='px-5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold hover:from-indigo-600 hover:to-purple-700 transition-all duration-300'>
      ...
      <div className='flex justify-center items-center'>
        <button className='text-xl md:text-3xl m-14 px-10 md:px-20 py-2 md:py-3 bg-amber-500 rounded-full text-white font-semibold hover:bg-amber-600 transition'>
          Romantic
        </button>
      </div>
      ...
      <div className='flex flex-wrap justify-center gap-6 px-4'>
        <Novelsection Bookname='Salaar Sikandar' Bookpicture='/SalaarSkindar.jpeg' Author_Name='Rizwan' Price='RS:1800' />
        <Novelsection Bookname='Salaar Imaama' Bookpicture='/SalaarImama.jpeg' Author_Name='Rizwan' Price='RS:1500' />
        <Novelsection Bookname='Aab E Hayaat' Bookpicture='/Aab_E_Hayat.jpeg' Author_Name='Rizwan' Price='RS:1900' />
        <Novelsection Bookname='Peer E Kamil' Bookpicture='/Peer_E_Kamil.jpeg' Author_Name='Rizwan' Price='RS:1400' />
      </div>
      <div className='flex flex-wrap justify-center gap-6 px-4'>
        <Novelsection Bookname='Salaar Sikandar' Bookpicture='/SalaarSkindar.jpeg' Author_Name='Rizwan' Price='RS:1800' />
        <Novelsection Bookname='Salaar Imaama' Bookpicture='/SalaarImama.jpeg' Author_Name='Rizwan' Price='RS:1500' />
      ...
      {/* More Sections */}
      <div className='flex justify-center items-center'>
        <button className='text-xl md:text-3xl mt-14  px-10 md:px-20 py-2 md:py-3 bg-amber-500 rounded-full text-white font-semibold hover:bg-amber-600 transition'>
          Story
        </button>
      </div>
